...
addon       = xbmcaddon.Addon('plugin.program.C.O.D')
...
go = True
icon0 = xbmcvfs.translatePath('special://home/addons/plugin.program.C.O.D/resources/icons/icon.png')
icon2 = xbmcvfs.translatePath('special://home/addons/plugin.program.C.O.D/resources/icons/icon2.png')
icon3 = xbmcvfs.translatePath('special://home/addons/plugin.program.C.O.D/resources/icons/icon3.png')
icon4 = xbmcvfs.translatePath('special://home/addons/plugin.program.C.O.D/resources/icons/icon4.png')
icon1 = xbmcvfs.translatePath('special://home/addons/plugin.program.C.O.D/resources/icons/icon1.png')
icon6 = xbmcvfs.translatePath('special://home/addons/plugin.program.C.O.D/resources/icons/icon6.png')
...
def homeLevel():
 ...
 #boasvindas
    boas = xbmcgui.ListItem("[COLOR lime][B]Green TV [/B][/COLOR]")
...
def SelectLevel():
    ...
    li = xbmcgui.ListItem('[B]TELEVIZIJA[/B]')
    ...
    li = xbmcgui.ListItem('[B]VOD FILMOVI[/B]')
    ...
    li = xbmcgui.ListItem('[B]VOD SERIJE[/B]')
    ...
    li = xbmcgui.ListItem('OBRISI CACHE')
