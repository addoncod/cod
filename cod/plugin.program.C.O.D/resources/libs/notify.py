...
ENABLE         = diss.ENABLE
HEADERTYPE     = diss.HEADERTYPE if diss.HEADERTYPE == 'Image' else 'Text'
HEADERMESSAGE  = diss.HEADERMESSAGE
BACKGROUND     = diss.BACKGROUND
BACKGROUND2     = diss.BACKGROUND2
BACKGROUND3 = diss.BACKGROUND3
HEADERIMAGE    = diss.HEADERIMAGE
THEME1         = diss.THEME1
THEME2         = diss.THEME2
THEME3         = diss.THEME3
THEME4         = diss.THEME4
...
CONTACTFANART  = diss.CONTACTFANART if not diss.CONTACTFANART == 'http://' else BACKGROUND3
