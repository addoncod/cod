...
ENABLE         = diss.ENABLE
AUTOINSTALL    = diss.AUTOINSTALL
REPOADDONXML   = diss.REPOADDONXML
REPOZIPURL     = diss.REPOZIPURL
...
DEFAULTPLUGINS = ['metadata.album.universal', 'metadata.artists.universal', 'metadata.common.fanart.tv', 'metadata.common.imdb.com', 'metadata.common.musicbrainz.org', 'metadata.themoviedb.org', 'plugin.program.autocompletion']
